(ns physiotherapy-support.store
  "SSoT for the ISCO-08 3255 independent physiotherapy-support sole-
  proprietor actor. Store is a protocol injected into the
  `physiotherapy-support.actor` StateGraph — `MemStore` is the
  ...
  Domain:
    ...
    record   — a committed operating record under a client (assist
               note, monitoring note, direct physical manipulation,
               fall-risk exercise) — written ONLY via commit-record!,
